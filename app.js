...
function renderPointList() {
  ...
  points.forEach((p, i) => {
    ...
    const icon = `<span style="display:inline-block;width:10px;height:10px;border-radius:50%;background-color:${dotColor};vertical-align:middle;"></span>`;
    ...
    li.innerHTML = `
      <span style="display:flex;align-items:center;justify-content:center;width:20px">${icon}</span>
      ${name}
